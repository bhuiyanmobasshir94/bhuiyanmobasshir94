...
By day I'm a Staff ML Engineer at [Graaho Technologies](https://www.graaho.com/) in Dhaka, shipping recommendation, vision and LLM systems. I'm applying to US PhD programmes in computer science for Fall 2027.
...
**Things I've built that are worth a look**
...
- [Margin](https://www.margin.mobasshirbhuiya.com/): an adaptive writing tutor where an LLM grades and deterministic code decides what the learner is allowed to see. The [source](https://github.com/bhuiyanmobasshir94/margin) is private; access on request.
